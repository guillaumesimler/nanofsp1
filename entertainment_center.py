...
apocalypse_now = media.Movie("Apocalypse Now",
                             "Let's kill a colonel, sorry terminate \
                             his commands",
...
english_patient = media.Movie("The English Patient",
                              "A remembrance of a love story at the \
                              end of WWII",
...
inception = media.Movie("Inception",
                        "Using the full power of subconsciousness and dreams \
                        and changing it",
...
movies = [apocalypse_now, english_patient, inception,
          je_vais_bien, oceans_11, v_for_vendetta]
